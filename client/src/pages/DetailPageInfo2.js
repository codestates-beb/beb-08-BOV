  ...
  return (
    <>
      <div className='totalvolue-wrapper info2-display'>
        <div className='info2-value'>{collectionData.stats.total_volume ? collectionData.stats.total_volume.toFixed(4): "--"} ETH</div>
        <div className='info2-subject'>total volume</div>
      </div>
      <div className='floorprice-wrapper info2-display'>
        <div className='info2-value'>{collectionData.stats.floor_price ? collectionData.stats.floor_price.toFixed(4): "--"} ETH</div>
